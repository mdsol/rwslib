...
class TestStudySubjectsRequest(unittest.TestCase):
    ...
    def test_maps_response(self):
        ...
        response_content = b"""    <ODM FileType="Snapshot"
...
class TestPostDataRequest(unittest.TestCase):
    def test_post_data_request_response(self):
        ...
        response_content = b"""    <Response ReferenceNumber="82e942b0-48e8-4cf4-b299-51e2b6a89a1b"
              InboundODMFileOID=""
...
class TestGlobalLibraryVersionsRequest(unittest.TestCase):
    ...
    def test_post_data_request_response(self):
        """We can POST data and reformat the response"""
        response_content = b"""<ODM ODMVersion="1.3" Granularity="Metadata" FileType="Snapshot" FileOID="d26b4d33-376d-4037-9747-684411190179" CreationDateTime=" 2013-04-08T01:29:13 " xmlns="http://www.cdisc.org/ns/odm/v1.3" xmlns:mdsol="http://www.mdsol.com/ns/odm/metadata">
        <Study OID="IANTEST">
            <GlobalVariables>
...
class TestGlobalLibrariesRequest(unittest.TestCase):
    ...
    def test_post_data_request_response(self):
        """We can POST data and reformat the response"""
        response_content = b"""    <ODM FileType="Snapshot" FileOID="767a1f8b-7b72-4d12-adbe-37d4d62ba75e"
...
class TestClinicalStudiesRequest(unittest.TestCase):
    ...
    def test_process_response(self):
        ...
        t = self.create_request_object()
        response_content = b"""<ODM FileType="Snapshot" FileOID="" CreationDateTime="" ODMVersion="1.3"
